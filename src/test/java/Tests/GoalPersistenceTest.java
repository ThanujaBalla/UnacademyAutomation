...
public class GoalPersistenceTest extends BaseTest {
	...
	public void verifyGoalIsRetainedAfterLogoutAndRelogin() throws InterruptedException {
		...
		By loginButton = By.xpath("//*[@id='__next']/header/div[1]/div[2]/div[4]/div/button[1]/span");
		...
		By mobileInput = By.xpath("//*[@id='DrawerPaper']/div[2]/div[1]/div[2]/div/input");
		...
		By getOtpButton = By.xpath("//*[@id='DrawerPaper']/div[2]/div[1]/div[3]/button");

		WebElement getOtp = wait.until(ExpectedConditions.elementToBeClickable(getOtpButton));
		...
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("DrawerPaper")));
		...
		By goalDropdown = By.xpath("//*[@id=\"__next\"]/header/div[1]/div[1]/div[2]/div/button");

		WebElement goalButton = wait.until(ExpectedConditions.elementToBeClickable(goalDropdown));
		...
		By addGoalButton = By.xpath("/html/body/div[3]/div[3]/ul/div/div/li[2]/p");

		WebElement addGoal = wait.until(ExpectedConditions.elementToBeClickable(addGoalButton));
		...
		wait.until(ExpectedConditions.urlToBe("https://unacademy.com/explore"));

		Assert.assertEquals(driver.getCurrentUrl(), "https://unacademy.com/explore", "Explore page did not open.");
		...
		WebElement neet = wait.until(ExpectedConditions.visibilityOfElementLocated(neetGoal));
		...
		WebElement goalAfterAdd = wait.until(ExpectedConditions.elementToBeClickable(goalDropdown));
		...
		By neetVerification = By.xpath("//*[normalize-space()='NEET UG']");

		boolean neetExistsBeforeLogout = driver.findElements(neetVerification).size() > 0;

		Assert.assertTrue(neetExistsBeforeLogout, "NEET UG was not found after adding the goal.");

		System.out.println("NEET UG verified before logout.");
		...
		By profileButton = By.xpath("//*[@id='__next']/header/div[1]/div[2]/div[4]/div/div/picture/img");
		...
		By logoutButton = By.xpath("/html/body/div[3]/div[3]/ul/div[2]/div/p");
		...
		wait.until(ExpectedConditions.urlToBe("https://unacademy.com/"));

		Assert.assertEquals(driver.getCurrentUrl(), "https://unacademy.com/",
				"User was not redirected to homepage after logout.");

		System.out.println("Logout successful. Redirected to homepage.");
		...
		By mobileInputAgain = By.xpath("//*[@id='DrawerPaper']/div[2]/div[1]/div[2]/div/input");

		System.out.println("Waiting for you to click Log in...");

		WebElement mobileAgain = wait.until(ExpectedConditions.visibilityOfElementLocated(mobileInputAgain));
		...
		mobileAgain.sendKeys(ConfigReader.getProperty("mobile_number"));
		...
		By loginOtpButton = By.xpath("//*[@id='DrawerPaper']/div[2]/div[1]/div[3]/button");

		WebElement loginOtp = wait.until(ExpectedConditions.elementToBeClickable(loginOtpButton));
		...
		By finalGoalDropdown = By.xpath("//*[@id='__next']/header/div[1]/div[1]/div[2]/div/button");

		WebElement finalGoalButton = wait.until(ExpectedConditions.elementToBeClickable(finalGoalDropdown));
		...
		By finalNeetGoal = By.xpath("//*[normalize-space()='NEET UG']");

		boolean neetRetained = driver.findElements(finalNeetGoal).size() > 0;

		Assert.assertTrue(neetRetained, "NEET UG was not retained after logout and relogin.");

		System.out.println("PASSED - NEET UG was retained after logout and relogin.");
		 ...
		 * // ========================================================= // STEP 22:
		 * MANUAL OTP AGAIN // =========================================================
		 * // Enter OTP manually. // Wait until login drawer disappears. //
		 * =========================================================
		 * 
		 ...
		 * boolean neetRetained = driver.findElements(finalNeetGoal).size() > 0;
		 * 
		 * Assert.assertTrue( neetRetained,
